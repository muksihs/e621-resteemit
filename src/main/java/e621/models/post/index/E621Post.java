...
@JsonPropertyOrder({ "id", "tags", "locked_tags", "description", "created_at", "creator_id", "author", "change",
		"source", "score", "fav_count", "md5", "file_size", "file_url", "file_ext", "preview_url", "preview_width",
		"preview_height", "sample_url", "sample_width", "sample_height", "rating", "status", "width", "height",
		"has_comments", "has_notes", "has_children", "children", "parent_id", "artist", "sources" })
...
//	private Long parentId;
	...
	/**
	 * Not sure if these are strings or arrays of strings, I have yet to see any in
	 * a json response.
	 * 
	 * @return
	 */
...
//	}
	...
	/**
	 * parent id may either be a number or NULL. Must use a boxed type.
	 * 
	 * @return
	 */
//	@JsonProperty("parent_id")
